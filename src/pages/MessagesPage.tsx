...
const MessagesPage = () => {
  ...
  const mockUsers: ChatUser[] = [
    ...
    },
    {
      id: 'ai',
      username: 'AI Bot',
      profileImage: 'https://api.dicebear.com/7.x/avatars/svg?seed=ai',
      lastMessage: 'Hello! I am your AI bot.',
      lastMessageTime: 'now',
    },
  ];
  ...
  const aiBotReplies = [
    ...
    "I'm just a simple AI bot. Ask me anything!",
    "Have a great day! 😊"
  ];
  ...
  const handleSendMessage = () => {
    ...
    // If chatting with AI Bot, reply after a short delay
    if (selectedUser.username === 'AI Bot') {
      setTimeout(() => {
        const aiReply: Message = {
          id: (Date.now() + 1).toString(),
          senderId: selectedUser.id,
          receiverId: 'current_user',
          content: aiBotReplies[Math.floor(Math.random() * aiBotReplies.length)],
          timestamp: 'Just now',
        };
